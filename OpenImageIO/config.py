		...
		"commands" : [
			...
			"cd gafferBuild &&"
				" cmake"
			 	...
			 	" -D OPENEXR_IMATH_LIBRARY={buildDir}\\lib\\Imath-2_3.lib"
			 	" -D OPENEXR_ILMIMF_LIBRARY={buildDir}\\lib\\IlmImf-2_3.lib"
				" -D OPENEXR_IEX_LIBRARY={buildDir}\\lib\\Iex-2_3.lib"
				" -D OPENEXR_ILMTHREAD_LIBRARY={buildDir}\\lib\\IlmThread-2_3.lib"
