{
	...
	"platform:windows" : {
		...
		"commands" : [
			...
			"msbuild visual\\VS2017\\lz4.sln /m /verbosity:minimal /property:PlatformToolset=v141 /property:WindowsTargetPlatformVersion=10.0.17763.0 /t:Clean,Build /p:Platform=x64 /p:Configuration=Release",
