{
	...
	"platform:windows" : {
		...
		"environment" : {
			...
			"PATH" : "%ROOT_DIR%\\Qt\\working\\qt-everywhere-src-5.12.8\\qtbase\\lib;{buildDir}\\lib;{buildDir}\\bin;%PATH%",
		...
		"commands" : [
			...
			"copy {buildDir}\\bin\\zlib.dll %ROOT_DIR%\\Qt\\working\\qt-everywhere-src-5.12.8\\qtbase\\bin\\zlib.dll",
			"call configure.bat"
				" -prefix {buildDir}"
				" -plugindir {buildDir}\\qt\\plugins"
				" -release"
